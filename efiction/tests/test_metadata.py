...
class TestEFictionConverter(TestCase):
        ...
        old_authors = [
            {
                ...
                "bio": "",
                "image": "",
                "date": datetime.datetime(2006, 1, 6, 1, 2, 13),
                "admincreated": "0",
                "password": "xfghtu",
            },
            {
                ...
                "bio": "",
                "image": "bauthor2",
                "date": datetime.datetime(2006, 2, 9, 1, 37, 24),
                "admincreated": "1",
                "password": "xfghtu",
            },
            {
                ...
                "bio": "An author bio with some text in it",
                "image": "",
                "date": datetime.datetime(2006, 2, 16, 22, 58, 2),
                "admincreated": "1",
                "password": "xfghtu",
            },
            {
                ...
                "bio": "",
                "image": "",
                "date": datetime.datetime(2006, 2, 15, 23, 0),
                "admincreated": "1",
                "password": "xfghtu",
            },
            {
                ...
                "bio": "",
                "image": "eauthor5",
                "date": datetime.datetime(2006, 2, 16, 23, 0),
                "admincreated": "1",
                "password": "xfghtu",
            },
        ]
    ...
    def test_convert_story_tags_string_ratings(self):
        ...
        efiction_converter_string_ratings = create_efiction_converter(
            "efiction_string_ratings"
        )
        # Create databases for this test
        load_fixtures(
            efiction_converter_string_ratings.config,
            efiction_converter_string_ratings.sql,
        )
        ...
        self.assertEqual(
            {"categories": [6], "characters": [8], "classes": [], "rating": [3]}, result
        )
    ...
    def test_convert_stories(self):
        ...
        self.assertEqual(
            ...
            result[0],
            "Entities should be unencoded and leading and trailing spaces stripped",
        )
        self.assertEqual(
            [
                {
