...
/*!40000 ALTER TABLE `fanfiction_challenges` DISABLE KEYS */;

INSERT INTO fanfiction_challenges
VALUES
(1, 'admin', 1, 'Legends of K/S', '1', '', '<p>Stories of the legendary heroes shared around the campfire.</p>'),
(2, 'User1', 868, '10 Lines Never Used in a Film', '1,2', '', '<p>Use 1 or more of the then 10 sentences&nbsp;from the Youtube clip in a story.</p>'),
(3, 'User2', 1044, 'kirk not the captain', '-1', '', '"<p></p>\r\n<p class=\"MsoNormal\">1 kirk is not the Captain spock is.</p>\r\n"');

/*!40000 ALTER TABLE `fanfiction_challenges` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	(1,'Bacon ipsum','&nbsp;<p> &nbsp;</p>Meat-related text.',NULL,'1','3,10,16,26','2,1','3','2006-02-09 22:21:35','2006-02-09 22:21:35',2,'3,5','','1','1','',3992,0,2,2872,'0'),
